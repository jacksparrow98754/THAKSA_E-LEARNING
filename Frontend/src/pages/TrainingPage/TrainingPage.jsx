...
const testimonials = [
    { name: "Aditya Kumar", role: "ECE Graduate", text: "ThaksaAi's training program completely changed my learning approach. From weak fundamentals to confident problem solving in 3 months - the mentor feedback was incredibly practical.", rating: 5, avatar: "AK", color: "#6366f1" },
