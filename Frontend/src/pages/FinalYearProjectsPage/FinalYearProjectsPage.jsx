...
function WhatsAppFloat() {
    return (
        <Box sx={{ position: "fixed", bottom: { xs: 20, md: 28 }, right: { xs: 18, md: 28 }, zIndex: 9999, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 1.5 }}>
            ...
            <IconButton component="a" href="https://wa.me/919908597337?text=Hi%20ThaksaAi%2C%20I'm%20interested%20in%20Final%20Year%20Project%20guidance!" target="_blank" rel="noopener noreferrer" sx={{ width: 60, height: 60, bgcolor: "#25D366", color: "#fff", boxShadow: "0 8px 28px rgba(37,211,102,0.5)", "&:hover": { bgcolor: "#1ebe58", transform: "scale(1.12)" }, transition: "transform 0.2s" }}>
