...
const testimonials = [
    { name: "Aditya Kumar", role: "ECE Graduate", text: "THAKSA.AI's training program completely changed my learning approach. From weak fundamentals to confident problem solving in 3 months - the mentor feedback was incredibly practical.", rating: 5, avatar: "AK", color: "#6366f1" },
                ...
                <Container maxWidth="sm">
                    <RevealBox>
                        ...
                        <Typography sx={{ color: "rgba(255,255,255,0.65)", mb: 4, lineHeight: 1.75 }}>
                            Join THAKSA.AI's Training program and start building practical, real-world skills with structured mentor support.
                        </Typography>
